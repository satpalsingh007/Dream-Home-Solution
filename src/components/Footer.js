  ...
  return (
    <footer className="footer">
      <div className="footer-top">
        <h4>YOUR DREAM &nbsp;&nbsp; OUR TEAM</h4>
        <h3>Turning your dream home into reality with precision and passion</h3>
      ...
      <div className="footer-mid">
        <div className="footer-mid-left">
          <h3>Get in Touch</h3>
          <p>
            Don't Miss Any Update! Enter our email to stay connected and be the
            first to receive the latest updates, exclusive offers, and expert
      ...
      <div className="footer-end">
        © 2025 Dream Home Solutions. All Rights Reserved.
      </div>
    </footer>
  );
};
